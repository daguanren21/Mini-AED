<template>
    <view class="service_info p-x-20px">
        <view class="header">
            ...
            <view class="title">Mini AED</view>
            ...
            <view class="at-article__content">
                <view class="at-article__section">
                    <view class="at-article__p">
                        Mini AED是久心医疗科技（苏州）有限公司具有完全自主知识产权、面向社会公众、提供Mini AED 问题咨询、操作指南、个人中心等功能，为了给用户日常维护以及使用提供相关指南。
                    </view>
                </view>
            </view>
        </view>
        <view class="footer">
            <view>久心医疗科技（苏州）有限公司版权所有</view>
            <view>Copyright © 2022 Jousing. All Rights Reserved.</view>
        </view>
    </view>
</template>
